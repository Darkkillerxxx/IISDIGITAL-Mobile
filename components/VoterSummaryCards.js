    ...
    return(
        voterData ? 
            ...
            <View style={{...styles.TableContainer,...{justifyContent:'space-between'}}}>
               <View style={{width: '48%',elevation: 2,padding:10,borderWidth:1}}>
                   <View style={{width:'100%',alignItems: 'center'}}>
                       ...
                       <AppText style={{fontSize:12}}>Total : <AppTextBold>{voterData.MALE}</AppTextBold></AppText>
                   </View>
                   <View style={{width:'100%',flexDirection:'row',flex:1,padding:5,marginTop:5}}>
                       <View style={{width:'50%',borderRightWidth:1,alignItems: 'center'}}>
                           <AppText style={{fontSize:12}}>Voted</AppText>
                           <AppTextBold style={{marginTop:5}}>{voterData.VOTED_MALE}</AppTextBold>
                       </View>
                       <View style={{width:'50%',alignItems: 'center'}}>
                           <AppText style={{fontSize:12}}>Not Voted</AppText>
               ...
               <View style={{width: '48%',elevation: 2,padding:10,borderWidth:1}}>
                   <View style={{width:'100%',alignItems: 'center'}}>
                       ...
                       <AppText style={{fontSize:12}}>Total : <AppTextBold>{voterData.FEMALE}</AppTextBold></AppText>
                   </View>
                   <View style={{width:'100%',flexDirection:'row',flex:1,padding:5,marginTop:5}}>
                       <View style={{width:'50%',borderRightWidth:1,alignItems: 'center'}}>
                           <AppText style={{fontSize:12}}>Voted</AppText>
           ...
           <View style={{...styles.TableContainer,...{justifyContent:'space-between'}}}>
               <View style={{width: '48%',elevation: 2,padding:10,borderWidth:1}}>
                   <View style={{width:'100%',alignItems: 'center'}}>
                       ...
                       <AppText style={{fontSize:12}}>Total : <AppTextBold>{voterData.OTH}</AppTextBold></AppText>
                   </View>
                   <View style={{width:'100%',flexDirection:'row',flex:1,padding:5,marginTop:5}}>
                       <View style={{width:'50%',borderRightWidth:1,alignItems: 'center'}}>
                           <AppText style={{fontSize:12}}>Voted</AppText>
               ...
               <View style={{width: '48%',elevation: 2,padding:10,borderWidth:1}}>
                   <View style={{width:'100%',alignItems: 'center'}}>
                       ...
                       <AppText style={{fontSize:12}}>Total : <AppTextBold>{voterData.TOTAL}</AppTextBold></AppText>
                   </View>
                   <View style={{width:'100%',flexDirection:'row',flex:1,padding:5,marginTop:5}}>
                       <View style={{width:'50%',borderRightWidth:1,alignItems: 'center'}}>
                           <AppText style={{fontSize:12}}>Voted</AppText>
